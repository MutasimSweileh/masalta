                ...
                <div class="row justify-content-center">
                    <div class="col-md-7 col-12">
                        <div class="about-desc w-100">
                            <h2 class="mb-0"><span class="thm-clr d-block"><?= getTitle("about" . $plang) ?></span><?= $alt ?> </h2>
                            ...
                            <div class="row">
                                <div class="col-md-4 col-6">
                                    <div class="serv-box w-100">
                                        ...
                                        <div class="serv-box-inner">
                                            <h3 class="mb-0">
                                                <a href="#" title=""><?= plang('المهندسين المهنيين', 'Professional <br> Engineers') ?></a>
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 col-6">
                                    <div class="serv-box w-100">
                                        ...
                                        <div class="serv-box-inner">
                                            <h3 class="mb-0">
                                                <a href="#" title=""><?= plang('معدات عالية الجودة', 'high quality <br> equipment') ?></a>
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-6">
                                    <div class="serv-box w-100">
                                        ...
                                        <div class="serv-box-inner">
                                            <h3 class="mb-0">
                                                <a href="#" title=""><?= plang('أسعار <br> تنافسية', 'competitive <br> prices') ?></a>
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-5 col-12">
                        <div class="about-image position-relative w-100">
                            <span>23<sup>+</sup><i class="d-block"><?= plang('خبرة', 'Experience') ?></i></span>
        ...
        <div class="container">
            ...
            <div class="sec-title text-center w-100">
                <div class="sec-title-inner d-inline-block">
                    <h3 class="mb-0"><?= getTitle("products" . $plang) ?></h3>
                </div>
            </div>
    ...
    <div class="w-100 pt-100 paralx-70 blue-layer opc7 position-relative">
        ...
        <div class="container">
            <div class="sec-title w-100">
                <div class="sec-title-inner d-inline-block">
                    <h3 class="mb-0"><?= getTitle("gallery" . $plang) ?></h3>
                </div>
            </div>
        </div>
...
<section>
    <div class="w-100 faq-ser position-relative">
        <div class="container">
            <div class="sec-title w-100">
                <div class="sec-title-inner d-inline-block">
                    <span class="d-block thm-clr"><?= plang('الأسئلة الشائعة لدينا', 'OUR FAQ') ?></span>
                    <h3 class="mb-0"><?= plang('أسئلة مكررة', 'Freequently Ask Questions') ?></h3>
                </div>
            </div>
                    ...
                    <div class="col-md-6 col-sm-12 col-lg-6">
                        <div class="toggle w-100" id="toggle">
                            <div class="toggle-item w-100">
                                <h4 class="mb-0"><span>01.</span><?= plang('كيف يمكنني طلب قطع غيار؟', 'How can I order spare parts?') ?></h4>
                                <div class="toggle-content w-100">
                                    <p class="mb-0">


                                        <?= plang('- يمكن أن تقدم Masalta قائمة قطع الغيار سريعة الحركة

- يمكن للعميل تحديد الأجزاء التي يحتاجها في كتيبات قطع غيار ماسالتا

- يجب على العميل تقديم رقم طراز الجهاز ورقم الجزء واسم الجزء والكمية ، ثم ستصدر ماسالتا P / I للعميل', ' - Masalta could offer fast moving spare partslist
...
- Customer to provide machine’s model no.,part’s no., part’s name, and qty, then Masalta will issue P/I to customer') ?>
                            ...
                            <div class="toggle-item w-100">
                                <h4 class="mb-0"><span>03.</span><?= plang('ما هو المحرك الذي يجب علي اختياره؟', 'Which engine should I select?') ?></h4>
                                <div class="toggle-content w-100">
                                    <p class="mb-0">


                                        <?= plang('- يمكنك الاختيار حسب خبرتك الخاصة

- يمكنك اختيار تفضيل السوق المحلي الخاص بك

- يمكنك الاختيار من خلال دراسة المواصفات المختلفة للمحركات

- يمكنك الاختيار حسب الخدمات المختلفة التي تقدمها شركات المحركات في سوقك المحلي

- يمكن أن تقدم لك Masalta اقتراحات حسب معرفتها في السوق الخاص بك', ' - You may choose according to your ownexperience
...
- Masalta could offer you suggestionsaccording to its knowledge in your market') ?>
                            ...
                            <div class="toggle-item w-100">
                                <h4 class="mb-0"><span>04.</span><?= plang('كيف يمكنني أن أصبح تاجرًا حصريًا؟', 'How can I be an exclusive dealer?') ?></h4>
                                <div class="toggle-content w-100">
                                    <p class="mb-0">


                                        <?= plang('- يجب أن يكون التاجر الحصري أولاً تاجر مسالطة

- سيحسب Masalta حجم مبيعات التاجر في التاريخ ، ويقدر إمكانات نموه

- سيقدر Masalta قدرة التاجر في المبيعات والخدمة والدعاية للعلامة التجارية

- يؤكد كلا الطرفين أهداف الحجم السنوية وخطط الدعاية للعلامة التجارية

- يوقع الطرفان على الاتفاقية الحصرية

- لا يسمح لشركة delear الحصرية ببيع آلات البناء الخفيفة تحت العلامات التجارية الصينية الأخرى', ' - An exclusive dealer must firstly be aMasalta dealer
...
- Exclusive delear is not allowed to selllight construction machines under other Chinese brands') ?>
                            ...
                            <div class="toggle-item w-100">
                                <h4 class="mb-0"><span>05.</span><?= plang('كيف يمكنني أن أكون تاجرا؟', 'How can I be a dealer?') ?></h4>
                                <div class="toggle-content w-100">
                                    <p class="mb-0">


                                        <?= plang('من المتوقع أن يكون لدى تاجر Masalta:
...
- مخزون كاف من قطع الغيار', ' Masalta dealer is expected to have:
        ...
        <div class="container">
            <div class="banner-wrap position-relative text-center w-100">
                <div class="banner-inner d-inline-block">
                    <h2 class="mb-0"><?= $alt ?> </h2>
                    <p class="mb-0"><?= plang('شركة مصرية رائدة في مجال بيع وتصدير وتصنيع معدات البناء', 'A leading Egyptian company in the field of selling, exporting and manufacturing construction equipment') ?></p>
                    <a class="thm-btn thm-bg" href="<?= $core->getPageUrl("about" . $plang) ?>" title=""><?= plang("اقرأ المزيد", "Read More") ?><i class="flaticon-arrow-pointing-to-right"></i></a>
                </div>
            </div>
            <!-- Banner Wrap -->
        </div>
...
<section>
    <div class="w-100 nsae-blog position-relative">
        <div class="container">
            <div class="sec-title text-center w-100">
                <div class="sec-title-inner d-inline-block">
                    <h3 class="mb-0"><?= getTitle("news" . $plang) ?></h3>
                </div>
            </div>
                            ...
                            <div class="post-box w-100 text-center">
                                ...
                                <div class="post-info w-100">
                                    ...
                                    <div class="post-info-bottom d-flex flex-wrap w-100">
                                        ...
                                        <span class="d-inline-block"><i class="flaticon-arrow-pointing-to-right"></i><a href="news<?= $plang ?>.php?id=<?= $products[$i]["id"] ?>" title=""><?= plang("اقرأ المزيد", "Read More") ?></a></span>
...
<section>
    <div class="w-100 clients-ser position-relative">
        <div class="container">
            ...
            <div class="sec-title text-center w-100">
                <div class="sec-title-inner d-inline-block">
                    <h3 class="mb-0"><?= plang('عملائنا', 'Our clients') ?></h3>
                </div>
            </div>
