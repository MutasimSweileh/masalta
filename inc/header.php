    ...
    <main>
        <header class="stick style1 w-100">
                ...
                <div class="container">
                    <div class="topbar-inner d-flex flex-wrap justify-content-between align-items-center w-100">
                        <ul class="topbar-info-list mb-0 list-unstyled d-inline-flex">
                            <li><i class="thm-clr fas fa-map-marker-alt"></i><?= getValue('footer_adress', $lang) ?></li>
            ...
            <div class="logo-info-bar-wrap w-100">
                <div class="container">
                    <div class="logo-info-bar-inner w-100">
                        <div class="logo-social d-inline-flex flex-wrap justify-content-between align-items-center">
                            <div class="logo">
                                <h1 class="mb-0">
                                    <a href="<?= $core->getPageUrl("index" . $plang) ?>" title="Home"><img class="img-fluid" src="images/logo.png" alt="Logo" srcset="images/logo.png" /></a>
                                </h1>
                            </div>
                            <!-- Logo -->
                        </div>
                        ...
                        <div class="social-links">
                            <a href="<?= getValue("facebook") ?>" title="Facebook" target="_blank"><i class="fab fa-facebook-f"></i></a>
                            <a href="<?= getValue("twitter") ?>" title="Twitter" target="_blank"><i class="fab fa-twitter"></i></a>
                            <a href="<?= getValue("instagram") ?>" title="Skype" target="_blank"><i class="fab fa-instagram"></i></a>
                            <a href="<?= getValue("youtube") ?>" title="Vimeo" target="_blank"><i class="fab fa-youtube"></i></a>
                        </div>
        ...
        <div class="sticky-menu">
            <div class="container">
                <div class="sticky-menu-inner d-flex flex-wrap align-items-center justify-content-between w-100">
                    <div class="logo">
                        <h1 class="mb-0">
                            <a href="#" title="Home"><img class="img-fluid" src="images/logo.png" alt="Logo" srcset="images/logo.png" /></a>
                        </h1>
                    </div>
                    <!-- Logo -->
        ...
        <div class="rspn-hdr">
            ...
            <div class="lg-mn">
                <div class="logo">
                    <a href="<?= $core->getPageUrl("index" . $plang) ?>" title="Home"><img src="images/logo.png" alt="Logo" /></a>
                </div>
                <div class="rspn-cnt">
                    <span><i class="thm-clr far fa-envelope-open"></i><a href="javascript:void(0);" title=""><?= getValue('email') ?></a></span>
                    <span><i class="thm-clr fas fa-map-marker-alt"></i><?= getValue('footer_adress', $lang) ?></span>
                </div>
