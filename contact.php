...
">
    ...
    display: inline;" placeholder="Write Code" required="required" autocomplete="off">
      ...
      <div class="col-md-6">
        ...
        <div class="icon-box media mb-15"> <a class="media-left  flip ml-20" href="#"> <i class="fab fa-map-marker"></i></a>
        ...
        <div class="icon-box media mb-15"> <a class="media-left  flip ml-15 " href="#">
            <i class="fab fa-phone"></i></a>
          <div class="media-body">
            <h5 class="mt-0">Mobile</h5>
            <p><a href="tel:<?= getValue("mobilepage") ?>"> <?= getValue("header_phone") ?></a></p>
          </div>
        </div>
        <div class="icon-box media mb-15"> <a class="media-left flip ml-15" href="#"> <i class="fab fa-envelope"></i></a>
          <div class="media-body">
